...
class GridManager:
    def __init__(self, grid_size=10, grid_resolution=0.2, cell_persistence=2.0):
        ...
        for x in range(self.grid_size):
            for y in range(self.grid_size):
                if self.occupancy_grid[x][y]:
                    ...
                    new_world_x = world_x * cos_yaw - world_y * sin_yaw + dx
                    new_world_y = world_x * sin_yaw + world_y * cos_yaw + dy
